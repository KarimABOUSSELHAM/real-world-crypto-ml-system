...
COPY services/news-sentiment /app/services/news-sentiment
...
COPY --from=builder /app/services/news-sentiment /app/services/news-sentiment
...
ENV PYTHONPATH="/app/services/news-sentiment/src"
...
COPY --from=cleaner /app/services/news-sentiment /app/services/news-sentiment

CMD ["python", "/app/services/news-sentiment/src/news_sentiment/main.py"]
